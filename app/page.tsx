      ...
      >
        ...
        <div className="relative z-10 space-y-6">
          ...
          <p className="mx-auto max-w-3xl text-lg text-[#4b5563]">
            O Projeto de Excelência Operacional &quot;Operador Nota 1000&quot;
            busca premiar os operadores com a melhor performance ao longo do
            projeto, ensinando boas práticas aos operadores e garantindo
            qualidade e desempenho ao proprietário.
          </p>
        </div>
      </section>
